# Power Garden: lossless visible rendering
...
The final suite executed **47/47 successful native-image cases**, covering
**14,675 scalar occurrences**. It recorded **66 passing assertions,
...
The final full run uses source revision `0c967cf82b17485ff291876b2228972b7bf149bb`; its exact executed file
...
requiring approximately `63.999295` bits of distinction per unrestricted
...
959,990 fully utilized 24-bit pixels, excluding structure;
...
The final run was completed at 2026-09-09T07:36:42.538311+00:00. It used Python 3.12.13,
...
| --- | ---: | --- | ---: | ---: | ---: |
| Six-value preview | 6 | 1712×432 | 3,989 | 0.060 | 0.463 |
| Saved primitive subset | 89 | 1712×3072 | 30,769 | 0.357 | 1.050 |
| Saved Phase 2 trial | 156 | 1712×4744 | 53,920 | 0.391 | 1.259 |
| Eight saved complex paths | 1,632 | 1712×28328 | 350,686 | 3.587 | 6.392 |
| Three saved 600-neuron vectors | 1,800 | 1712×27096 | 403,887 | 4.175 | 5.665 |
| Maximum single vector | 2,382 | 1712×35280 | 534,130 | 5.152 | 7.749 |
